  ...
  <v-navigation-drawer v-model="drawer" app left temporary>
    ...
    <template v-if="isLogin" #append>
      ...
      >
        ...
        <v-list-item-content>
          <v-list-item-title>{{ speculation.title }}</v-list-item-title>
        </v-list-item-content>
      </v-list-item>
      ...
      >
        ...
        <v-list-item-content>
          <v-list-item-title>{{ mesdemande.title }}</v-list-item-title>
        </v-list-item-content>
      </v-list-item>
      <v-list-item
      ...
      >
        ...
        <v-list-item-content>
          <v-list-item-title>{{ speculationAg.title }}</v-list-item-title>
        </v-list-item-content>
      </v-list-item>
      <v-list-item
        v-if="isAdmin"
      ...
      >
        ...
        <v-list-item-content>
          <v-list-item-title>{{ demande.title }}</v-list-item-title>
        </v-list-item-content>
      </v-list-item>
      <v-divider />
      <v-list nav>
