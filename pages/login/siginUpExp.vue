                ...
                <v-row>
                  ...
                  <v-col cols="12" sm="6">
                    <v-text-field
                      ...
                      :label="$t('exploitant.form.prenom')"
                      autocomplete="off"
                      outlined
                      dense
                  ...
                  <v-col cols="12" sm="6">
                    <v-text-field
                      ...
                      :label="$t('exploitant.form.adresse')"
                      autocomplete="off"
                      outlined
                      dense
                  ...
                  <v-col cols="12" sm="6">
                    <v-text-field
                      v-model.trim.lazy="form.adresseCo"
                      :label="$t('exploitant.form.adresseCo')"
                      autocomplete="off"
                      outlined
                      dense
                    ></v-text-field>
                  ...
                  <v-col cols="12" sm="6">
                    <v-text-field
                      v-model.trim.lazy="form.telephoneCo"
                      :label="$t('exploitant.form.telephoneCo')"
                      type="number"
                      autocomplete="off"
                      outlined
                      dense
                  ...
                  <v-col cols="12" sm="6">
                    <v-text-field
                      ...
                      :label="$t('exploitant.form.longitude')"
                      type="number"
                      autocomplete="off"
                      outlined
                      dense
                  ...
                  <v-col cols="12" sm="6">
                    <v-text-field
                      ...
                      :label="$t('exploitant.form.latitude')"
                      type="number"
                      autocomplete="off"
                      outlined
                      dense
  ...
  methods: {
    ...
    async submitForm() {
      ...
      if (this.isFormValid) {
        ...
        try {
          await this.$api.saveUserAuthExploitant({
            ...
            telCooperative: this.telephoneCo,
            adrPersonnel: this.form.adresse,
            adrCooperative: this.form.adresseCo,
